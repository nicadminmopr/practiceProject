...
class UploadCircularScreen extends StatelessWidget {
  final UploadCircularController controller =
  Get.put(UploadCircularController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Upload Circular/Event',style: AppTextStyles.body(fontSize: 15, color: Colors.black),),
      ),
      body: Padding(
            ...
            children: [
              ...
              Center(
                child: MaterialButton(color: Colors.black,
                  ...
                  child: Text('Upload',style: AppTextStyles.body(fontSize: 15, color: Colors.white),),
                ),
              ),
            ],
          ),
